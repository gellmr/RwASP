...
{
  /*
   * This class was generated by Gemini from natural language pseudocode.
   * I copied some address values from the database and wrote english instructions to describe how I wanted them to be parsed
   ...
   * You must be on migration 1, 2 or 3 to use this script.
  */
  ...
  */
  ...
  // The above prompt generated an initial script which worked with only a few minor changes. Below is the finished version.
